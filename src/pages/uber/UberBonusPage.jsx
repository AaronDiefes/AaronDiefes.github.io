  ...
  return (
    <div>
      ...
      <header className="landing-header">
        <h1>Bonus Algorithms</h1>
        <p>Advanced Optimizations Beyond Core T1-T5</p>
      </header>
      ...
      <div className="container">
        ...
        {/* B1: KD-Tree + Manhattan Routing Section */}
        <section className="section">
          <h2>B1: KD-Tree + Manhattan Routing<span className="complexity-badge">O(n × (log m + E log V))</span></h2>
        ...
        {/* B2: Workload Balancing Section */}
        <section className="section">
          <h2>B2: Workload Balancing<span className="complexity-badge">O(n × m)</span></h2>
        ...
        {/* B3: Traffic-Aware Routing Section */}
        <section className="section">
          <h2>B3: Traffic-Aware Routing<span className="complexity-badge">O(n × (log m + E log V))</span></h2>
        ...
        {/* B4: Hybrid Binary Search + Caching Section */}
        <section className="section">
          <h2>B4: Hybrid Binary Search + Caching<span className="complexity-badge">O(n × log m) amortized</span></h2>
        ...
        {/* Comparison Section */}
        <section className="section">
          <h2>Bonus Algorithm Comparison</h2>
          <p>
        ...
        <section className="section">
          ...
          <div className="quick-links">
            ...
            <Link to="/projects/uber/docs" className="quick-link">Back to Documentation →</Link>
          </div>
        </section>
      </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '2rem' }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                ...
                <li style={{ marginBottom: '0.75rem' }}><Link to="/projects/uber/docs" style={{ color: '#ecf0f1', textDecoration: 'none', transition: 'color 0.15s' }}>Uber Algorithmic System</Link></li>
                ...
                <li style={{ marginBottom: '0.75rem', color: '#95a5a6' }}>Bonus Algorithms</li>
              </ul>
            </div>
