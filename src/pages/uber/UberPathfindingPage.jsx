...
const TOC = [
  ...
  { id: 'graph-representation', label: 'Graph Representation', level: 2 },
  { id: 'haversine-distance', label: 'Haversine Distance', level: 2 },
  { id: 'dijkstras-algorithm', label: "Dijkstra's Algorithm", level: 2 },
  { id: 'priority-queue-with-heapq', label: 'Priority Queue with heapq', level: 2 },
...
function UberPathfindingPage() {
  return (
    ...
    >
      ...
      <DocsSection id="graph-representation" title="Graph Representation">
        <p>
      ...
      <DocsSection id="haversine-distance" title="Haversine Distance">
        <p>
      ...
      <DocsSection id="dijkstras-algorithm" title="Dijkstra's Algorithm">
        <p>
      ...
      <DocsSection id="priority-queue-with-heapq" title="Priority Queue with heapq">
        <p>
