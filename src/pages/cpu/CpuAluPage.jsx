        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '2rem' }}>
            ...
            <div>
              ...
              <p style={{ color: '#bdc3c7', lineHeight: 1.8 }}>Building a 32-bit processor from the ground up.</p>
            </div>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                ...
                <li style={{ marginBottom: '0.75rem' }}><a href="https://github.com/AaronDiefes/CPU" target="_blank" rel="noopener noreferrer" style={{ color: '#ecf0f1', textDecoration: 'none', transition: 'color 0.15s' }}>CPU Repository</a></li>
